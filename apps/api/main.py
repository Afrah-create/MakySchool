...
def create_app() -> FastAPI:
    ...
    mount_v1_and_legacy(app, rollover.router, "/api/schools/rollover")
    ...
    mount_v1_and_legacy(app, learner.router, "/api/schools/learner")
    ...
    mount_v1_and_legacy(app, theology.router, "/api/schools/theology")
