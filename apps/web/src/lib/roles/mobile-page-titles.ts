const TITLE_BY_PATH: Record<string, string> = {
  ...
  "/dashboard/teaching-plans": "Teaching plans",
  "/dashboard/primary": "Primary",
  "/dashboard/primary/marks": "Primary marks",
  "/dashboard/primary/results": "Primary results",
  "/dashboard/primary/report-cards": "Report cards",
  "/dashboard/primary/ple": "PLE results",
  "/dashboard/primary/setup": "Primary setup",
  "/dashboard/olevel": "O-Level",
  "/dashboard/olevel/exam-sessions": "Exam sessions",
  "/dashboard/olevel/students": "O-Level students",
  "/dashboard/olevel/results": "O-Level results",
  "/dashboard/olevel/marks": "Marks review",
  "/dashboard/olevel/setup": "O-Level setup",
  ...
  "/teacher/teaching-plans": "Teaching plans",
  "/teacher/resources": "Resources",
  "/teacher/primary/marks": "Primary marks",
  "/teacher/olevel": "O-Level marks",
  "/teacher/olevel/marks": "Enter O-Level marks",
